...
public class GameAlphabet extends AppCompatActivity {
    ...
    private void getGamesList() {
        RequestQueue requestQueue = Volley.newRequestQueue(GameAlphabet.this);
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
                Request.Method.GET,
                URL + "/games/letter/" + letter,
                null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(GameAlphabet.this, "Error: " + error.toString(), Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void createList(List<JSONObject> listOfGames) throws JSONException {
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(GameAlphabet.this, itemDataList, R.layout.activity_game_search,
